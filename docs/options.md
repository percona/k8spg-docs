...
can use the [PostgreSQL dynamic configuration method :material-arrow-top-right:](https://patroni.readthedocs.io/en/latest/dynamic_configuration.html)
...
restart, except [the options with the postmaster context :material-arrow-top-right:](https://www.postgresql.org/docs/16/view-pg-settings.html).
...
!!! note
    ...
    [Patroni dynamic configuration options :material-arrow-top-right:](https://patroni.readthedocs.io/en/latest/dynamic_configuration.html).
