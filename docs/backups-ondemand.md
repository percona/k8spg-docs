...
To make an on-demand backup manually, you need a backup configuration file. You can use the example of the backup configuration file [deploy/backup.yaml :material-arrow-top-right:](https://github.com/percona/percona-postgresql-operator/blob/main/deploy/backup.yaml):
...
[pgBackRest command line options :material-arrow-top-right:](https://pgbackrest.org/configuration.html).
