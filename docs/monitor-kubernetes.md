...
1. To install the Victoria Metrics Kubernetes monitoring stack with the default parameters, use the quick start command. Replace the following placeholders with your values:
