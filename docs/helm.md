...
3. Install the Percona Operator for PostgreSQL:
    ...
    The `my-namespace` is the name of your namespace. The `my-operator` parameter is the name of [a new release object :material-arrow-top-right:](https://helm.sh/docs/intro/using_helm/#three-big-concepts)
