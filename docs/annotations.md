...
| `pgv2.percona.com/logcollector-config-hash`                 | Pods, StatefulSets (instance sets) | Hash of the Fluent Bit and logrotate configuration. Used to detect config changes and roll instance Pods when [persistent logging](persistent-logging.md) settings change. | `a1b2c3d4...` |
