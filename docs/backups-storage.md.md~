...
=== ":simple-amazons3: S3-compatible backup storage"
     ...
     * S3 credentials such as S3 key and secret to access the storage. These are stored in an encoded form in [Kubernetes Secrets :material-arrow-top-right:](https://kubernetes.io/docs/concepts/configuration/secret/) along with other sensitive information. 
...
=== ":simple-googlecloud: Google Cloud Storage"
    ...
    To use [Google Cloud Storage :material-arrow-top-right:](https://cloud.google.com/storage) as
    ...
    **Configuration steps** 
    ...
    1. Create your service account key following the [official Google Cloud instructions :material-arrow-top-right:](https://cloud.google.com/iam/docs/creating-managing-service-account-keys).
    ...
    3. Create the [Kubernetes Secret :material-arrow-top-right:](https://kubernetes.io/docs/concepts/configuration/secret/). The Secret consists of 
...
=== ":material-microsoft-azure: Azure Blob Storage (tech preview)"
    ...
    To use [Microsoft Azure Blob Storage :material-arrow-top-right:](https://azure.microsoft.com/en-us/services/storage/blobs/) for storing backups, you need the following:

    * a proper Azure container name. 
    * Azure Storage credentials. These are stored in an encoded form in the [Kubernetes Secret :material-arrow-top-right:](https://kubernetes.io/docs/concepts/configuration/secret/).
...
by using the [WAL asynchronous archiving :material-arrow-top-right:](https://pgbackrest.org/user-guide-centos7.html#async-archiving) feature.
...
[gpBackRest official documentation :material-arrow-top-right:](https://pgbackrest.org/user-guide-centos7.html#async-archiving)
and in [this blog post :material-arrow-top-right:](https://www.percona.com/blog/how-pgbackrest-is-addressing-slow-postgresql-wal-archiving-using-asynchronous-feature/).
