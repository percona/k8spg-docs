...
For more information on GKE, see the [Kubernetes Engine Quickstart :material-arrow-top-right:](https://cloud.google.com/kubernetes-engine/docs/quickstart).
...
1. [gcloud :material-arrow-top-right:](https://cloud.google.com/sdk/docs/quickstarts). This tool is part of the Google Cloud SDK. To install it, select your operating system on the [official Google Cloud SDK documentation page :material-arrow-top-right:](https://cloud.google.com/sdk/docs) and then follow the instructions.

2. [kubectl :material-arrow-top-right:](https://cloud.google.com/kubernetes-engine/docs/quickstart#choosing_a_shell). This is the Kubernetes command-line tool you will use to manage and deploy applications. To install the tool, run the following command:
