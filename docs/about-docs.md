...
This documentation describes how to deploy, configure, and operate Percona Operator for PostgreSQL on Kubernetes. It also includes reference material for Custom Resource options, backup and restore settings, and related topics.

## Documentation versions and the version switcher
...
To report a problem with the documentation, use the feedback widget at the bottom of the page or open a ticket in the [Percona Operator for PostgreSQL project :octicons-link-external-16:](https://jira.percona.com/projects/K8SPG/issues) on Jira.
