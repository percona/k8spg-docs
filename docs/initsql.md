...
psql interactive terminal [will execute :octicons-link-external-16:](https://www.postgresql.org/docs/current/app-psql.html#APP-PSQL-OPTION-FILE) these initialization statements when the cluster is created, [after creating custom users and databases](users.md#custom-users-and-databases) specified in the Custom Resource.
