...
!!! note
    ...
    There are two [finalizers :material-arrow-top-right:](https://kubernetes.io/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/#finalizers) defined in the Custom Resource, which define whether TLS-related objects and data volumes should be deleted or preserved when the cluster is deleted.
    ...
    * `finalizers.percona.com/delete-pvc`: if present, [Persistent Volume Claims :material-arrow-top-right:](https://kubernetes.io/docs/concepts/storage/persistent-volumes/) for the database cluster Pods are deleted when the cluster deletion occurs.
...
You can uninstall the Operator by deleting the [Deployments :material-arrow-top-right:](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/)
related to it.
{.power-number}
...
you can also delete the [CustomRecourceDefinitions (CRDs) :material-arrow-top-right:](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/#customresourcedefinitions). 
